...
from layers.mha_layer import RelPositionMultiHeadAttention, MultiHeadAttention
from layers.positional_encoding import PositionalEncoding, PositionalEncodingConcat
from layers.glu import GLU
from utils.shape_utils import shape_list
...
class ConformerEncoder(tf.keras.Model):
    ...
    def call(
        ...
        **kwargs,
        ...
        outputs = self.linear(inputs, training=training)
        pe = self.pe(outputs)
        outputs = self.do(outputs, training=training)
